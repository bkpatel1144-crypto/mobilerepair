    ...
    >
      <div className="space-y-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          {t('pages.masters.partyCategories.thisNameWillBeVisibleIn')}
        </p>
      </div>
      <div className="space-y-1.5">
        <Input value={isNew ? 'Auto-generated code' : editing.code} disabled />
        <p className="text-xs text-muted-foreground">
          {t('pages.masters.partyCategories.uniqueSystemIdentifierAutoGeneratedBut')}
        </p>
      </div>
      <div className="space-y-1.5">
      ...
      <div className="flex flex-wrap gap-4 text-sm">
        <label className="flex items-center gap-1.5">
          ...
          />
          {t('pages.masters.partyCategories.defaultForCustomer')}
        </label>
        <label className="flex items-center gap-1.5">
          <Checkbox
          ...
          />
          {t('pages.masters.partyCategories.defaultForSupplier')}
        </label>
      </div>
    </FormModal>
  )
