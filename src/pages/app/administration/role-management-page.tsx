        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => setStatusFilter('active')}>
              <ListChecks />
              {t('pages.administration.roleManagement.showActiveRoles')}
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => void refetch()}>
              <RefreshCw />
              {t('pages.administration.roleManagement.reloadFromServer')}
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
          ...
          <>
            ...
            {selectedRole.protected && (
              <DetailNote
                ...
                tone="amber"
              >
                {t('pages.administration.roleManagement.thisRoleHasFullAccessBy')}
              </DetailNote>
            )}
          </>
        )}
